...
16. In the equation, $\AA \BB = \CC$, let $\AA=\left[ \begin{smallmatrix}1&4&7\\2&5&8\\3&6&9\end{smallmatrix}\right]$.  Build a $\BB$ matrix with only 1s and 0s such that the values on the diagonal of $\CC$ are 1, 8, 6 (in that order).  Show your R code for $\AA$, $\BB$ and $\AA \BB$.
