...
The chapter uses two data sets described in Section \@ref(sec-tslab-data).  The main one is a CO$_2$ data set: [CO2_data.RData](./data/CO2_data.RData). The second is   a Northern Hemisphere temperature data set:  [NHemiTemp_data.RData](./data/NHemiTemp_data.RData).  The problems use a data set on hourly phytoplankton counts: [hourly_phyto.RData](./data/hourly_phyto.RData). After downloading via the links, load the data
```{r tslab-load-datasets, eval=FALSE}
load("CO2_data.RData")
...
## CO$_2$ and global temperature data set {#sec-tslab-data}
...
```{r tslab-copy-data-file-to-doc, include=FALSE, purl=FALSE}
...
```{r tslab-copy-temp-data-to-doc, include=FALSE, purl=FALSE}
#If bookdown is being run, then we are at the top level
#make sure the Rdata is in the docs folder
