...
The chapter uses two data sets described in Section \@ref(sec-ts-data).  The main one is a CO$_2$ data set: [CO2_data.RData]("./data/CO2_data.RData"). The second is   a Northern Hemisphere temperature data set:  [NHemiTemp_data.RData]("./data/NHemiTemp_data.RData").  After downloading via the links, load the data
...
```{r ts-HW1_pre, eval=FALSE, echo=TRUE}
...
```{r ts-reset, echo=FALSE, include.source=FALSE}
```
