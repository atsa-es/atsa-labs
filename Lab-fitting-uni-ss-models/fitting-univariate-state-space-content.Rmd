```{r uss-RUNFIRST, echo=FALSE, include.source=FALSE}
```
...
```{r uss-loadpackages, results='hide', message=FALSE, warnings=FALSE}
library(MARSS)
library(stats)
library(forecast)
```
...
Here we show how to fit model 3, Equation \@ref(eq:uss-random-walk-w-noise-w-drift), with JAGS.
First load the required packages:
```{r uss-jags-packages, warnings=FALSE, messages=FALSE, results='hide'}
require(coda)
require(R2jags)
```
