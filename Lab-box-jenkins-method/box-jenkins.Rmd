...
We will catch landings from Greek waters (`greeklandings`) and the Chinook landings  (`chinook`) in Washington data. These datasets are in the **FishForecast** package hosted on  Github [safs-timeseries](https://github.com/Fish-Forecast/FishForecast).  Install  using the **devtools** package.
