```{r jags-RUNFIRST, echo=FALSE}
removefiles=c()
```


# Bayesian time-series analysis using JAGS  {#chap-jags}

In this lab, we will work through using Bayesian methods to estimate parameters in time series models using JAGS. There are a variety of software tools to do this. R has a number of packages available on the TimeSeries task view, 
\newline \newline
 http://cran.r-project.org/web/views/TimeSeries.html 
\newline \newline
Software to implement more complicated models is also available, and many of you are probably familiar with these options (AD Model Builder and Template Model Builder, WinBUGS, OpenBUGS, JAGS, to name a few). We will be using JAGS because (1) it is platform independent, (2) most of the glitches have been worked out, and (3) it is easy to use via R. After updating to the latest version of R, install JAGS for your operating platform here:
\newline \newline
...
```{r jags-lr1, echo=TRUE, results='hide'}
###############################################################
...
```{r jags-call-fun1, echo=TRUE, results='hide', eval=TRUE}
...
```{r jags-lm1ar, echo=TRUE, results='hide', eval=TRUE}
###############################################################
...
```{r jags-lm1ar-mod, echo=TRUE, results='hide', eval=TRUE}
...
```{r jags-lm1ar-plot-func, echo=TRUE, results='hide', eval=TRUE}
...
```{r jags-lm1ar-plot, echo=TRUE, results='hide', eval=FALSE, fig.show='hide'}
...
```{r jags-ar1, echo=TRUE, results='hide'}
################################################################
...
```{r jags-ar1est, echo=TRUE, results='hide'}
################################################################
...
```{r jags-ss1, echo=TRUE, results='hide'}
###############################################################
...
```{r jags-cov, echo=TRUE, results='hide'}
###############################################################
...
```{r jags-cov-forecast, echo=TRUE,results='hide'}
...
*  Based on your visual inspection, has the MCMC chain convered?
*  What is the ACF of the first MCMC chain?
...
9. The following is a real life dataset from the Upper Skagit River (Puget Sound, 1952-2005) on salmon spawners and recruits:
...
```{r jags-reset, echo=FALSE, include.source=FALSE}
